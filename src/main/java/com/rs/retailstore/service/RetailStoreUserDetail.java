...
@Service
public class RetailStoreUserDetail implements UserDetailsService {

@Autowired
private CustomerRepository customerRepository; //thang nay de goi thong tin user, lay data tu database, de co the dung duoc customerRepository moi tao
    @Override
